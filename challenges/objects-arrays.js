...
const uni = graduates.map(element => element["university"]).filter(element => element.includes("Uni"));
console.log(uni);
...
*/
const populationTotal = zooAnimals.reduce((acc, currVal) => acc + currVal["population"], 0);
